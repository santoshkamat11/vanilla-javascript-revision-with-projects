// You have to pretend to use word api which will contain an object and you have to print
// definition from all the results of that word api
// You have to take input from input tag
// You have to print it in the dom
// If you are using bootstrap then it is a plus
